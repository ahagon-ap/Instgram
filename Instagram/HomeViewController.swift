...
class HomeViewController: UIViewController, UITableViewDataSource, UITableViewDelegate  {
    ...
    @objc func handleCommentButton(_ sender: UIButton) {
        ...
        let commentVC = storyboard.instantiateViewController(withIdentifier: "Comment") as! CommentController
        commentVC.modalPresentationStyle = .fullScreen // モーダルの表示スタイルを設定
        commentVC.postData = postData // 選択された投稿データを渡す
